  ...
  if ((content.type === 'MCQ_ANALYSIS' || content.type === 'MCQ_SIMPLE') && content.mcqData) {
      ...
      return (
          <div className="flex flex-col h-full bg-slate-50 animate-in fade-in relative">
               ...
               {showSubmitModal && (
                   <div className="absolute inset-0 z-50 bg-slate-900/80 backdrop-blur-sm flex items-center justify-center p-4">
                       <div className="bg-white rounded-2xl p-6 w-full max-w-sm text-center shadow-2xl animate-in zoom-in">
                   ...
                   <div className="absolute inset-0 z-50 bg-slate-900/90 backdrop-blur-sm flex items-center justify-center p-4">
                       <div className="bg-white rounded-3xl p-8 max-w-sm w-full text-center shadow-2xl animate-in zoom-in">
                           ...
                           <div className="space-y-3">
                               ...
                               >
                                   <Trophy size={20} /> Unlock Now (5 Coins)
                               </button>
                               <button 
                                   onClick={handleExit}
                   ...
                   {hasMore ? (
                       <>
                           ...
                           <button 
                               ...
                               disabled={!showResults && Object.keys(mcqState).length === 0} // Can't submit empty? 
                               className="bg-blue-100 hover:bg-blue-200 text-blue-800 font-bold py-3 px-6 rounded-xl transition-all active:scale-95 flex items-center gap-2"
                           >
